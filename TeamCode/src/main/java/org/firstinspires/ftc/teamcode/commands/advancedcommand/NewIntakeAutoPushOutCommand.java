...
public class NewIntakeAutoPushOutCommand extends SequentialCommandGroup {
    public NewIntakeAutoPushOutCommand(int ext) {
        super(
                new ExtensionPositionCommand(ext),

//                new WaitCommand(5000),
                new RotateStateCommand(NewIntakeSubsystem.RotateState.HORIZONTAL),
                new NewArmStateCommand(NewIntakeSubsystem.ArmState.AUTO),
